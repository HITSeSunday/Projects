				...
				<ul class="nav pull-right">
					...
					<img alt="" src="<%=basePath %>media/image/avatar3_small.jpg" />
						...
						<ul class="dropdown-menu">
							...
							<li><a href="<%=basePath %>ReserveSlide.html"><i class="icon-key"></i> Log Out</a></li>
					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="<%=basePath %>chat/sviewunreadchat.action">个人主页</a> 
					...
					<div class="span12">
						...
						<div class="span3">
							...
							<ul class="ver-inline-menu tabbable margin-bottom-10">
								...
								<li><a href="#tab_2" data-toggle="tab"><i class="icon-group"></i>开发成员</a></li>

								<li><a href="#tab_3" data-toggle="tab"><i class="icon-leaf"></i> Something To say</a></li>
										...
										<div class="accordion-group">
											...
											<div id="collapse_1" class="accordion-body collapse in">
												...
												<div class="accordion-inner">
													...
													MOOC将传统大学教育的优势逐渐剥夺，只剩下一个：师	生的面对面互动。大学四年，师生之间有多少在一起的时光？师	生之间的互动，不应只在课堂上进行。目前的情形是：学生想认	识教授们，却不敢，或不知道对方何时可以接见他们。教师们应	该主动一点，主动把自己的零散时间开放出来给学生。
										...
										<div class="accordion-group">
											...
											<div id="collapse_2" class="accordion-body collapse">
												...
												<div class="accordion-inner">
													...
													教师针对自己的可用时间，发布若干时间段，学生可以从	中选择适合自己的一个时间段，提交预约请求。这样，可以让师	生之间有了更多更加深入的交流沟通，不管是对学生还是老师都	有诸多益处
									...
									<div class="accordion in collapse" id="accordion2" style="height: auto;">
										...
										<div class="accordion-group">
											...
											<div id="collapse_2_1" class="accordion-body collapse in">
												...
												本站采用Struts基于MVC(Model-View-Controller)设计模式的应用构架，组员分工明确
									...
									<div class="accordion in collapse" id="accordion3" style="height: auto;">
										...
										<div class="accordion-group">
											...
											<div class="accordion-heading">
												...
												<font face="" size="4px"  color="">&nbsp;&nbsp;说实话，这个小网站花费了我们HitSunday不少心血，从无到有，从少到多，都是我们三个人一键一键敲出来的，
												虽说困难重重，但我们的目的很简单，能给大家带来方便就是我们最大的乐趣，当然，也有许多创造的快乐。<br/>
												&nbsp;&nbsp;我们这个网站还有诸多问题，希望大家能多多指教<br/>
												&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;——HitSunday全体成员敬上	</font>								
