...
<link href="<%=basePath%>media/css/daterangepicker.css" rel="stylesheet"
	type="text/css" />
...
<link href="<%=basePath%>media/css/jqvmap.css" rel="stylesheet"
	type="text/css" <%=basePath%> media="screen" />

<link href="<%=basePath%>media/css/jquery.easy-pie-chart.css"
	rel="stylesheet" type="text/css" <%=basePath%> media="screen" />
			...
			<div class="container-fluid">
				...
				<ul class="nav pull-right">
					...
					<li class="dropdown" id="header_inbox_bar"><a
						href="chat/tviewunreadchat?curchat.tid=<%=session.getAttribute("teacherId")%>"
						class="dropdown-toggle" data-toggle="dropdown"> <i
							class="icon-envelope"></i> <span class="badge"><s:property
									value="list.size()" /></span>
						...
						<ul class="dropdown-menu extended inbox">
							...
							<s:iterator value="list" var="Chat" status="std">
								<tr>
									<li><a
										href="treadchat?currentChat.tid=<s:property value="#Chat.tid" />&currentChat.sid=<s:property value="#Chat.sid" />&currentChat.writer=<s:property value="#Chat.writer" />">

											<span class="photo"><img
												src="<%=basePath%>media/image/avatar3.jpg" alt="" /></span> <span
											class="subject"> <span class="from"><td><s:property
															value="#Chat.writer" /></td></span> <span class="time"><td><s:property
															value="#Chat.mdateandtime" /></td></span>
					...
					<li class="dropdown" id="header_task_bar"><a href="#"
						class="dropdown-toggle" data-toggle="dropdown"> <i
							class="icon-tasks"></i> <span class="badge"><s:property
									value="lists.size()" /></span>
								...
								<tr>
									<li><a href="#"> <span class="task"> <span
												class="desc">
													...
													<td>被<s:property value="#sb.ssname" />预约
												</td>
		...
		<div class="page-sidebar nav-collapse collapse">
			...
			<ul class="page-sidebar-menu">
				...
				<li class="start active "><a href="#"> <i class="icon-home"></i>
						...
						<span class="title">本站简介</span> <span class="selected"></span>
		...
		<div class="page-content">
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><i class="icon-home"></i> <a href="#">个人主页</a> <i
				...
				<div id="dashboard">
					...
					<iframe src="<%=basePath%>ReserveSlide1.html" id="frame1"
						frameborder="0" width="1100" height="900"></iframe>
