		...
		<div class="page-content">
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					...
					<div class="span12">
					<iframe src="clock.html" scrolling="no" id="frame1" frameborder="0" width="90%" height="130"></iframe>
					<iframe src="jdbc/studentShow?studentid=<%=session.getAttribute("studentid") %>" scrolling="no" id="frame1" frameborder="0" width="40%" height="500"></iframe>
					<iframe src="dosthstudent2.jsp" name="showframe" id="frame1" frameborder="0" scrolling="no" width="50%" height="548"></iframe>
