				...
				<ul class="nav pull-right">
					...
					<li class="dropdown user">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="../s_calendar.jsp"><i class="icon-calendar"></i> 我的预约</a></li>
...
<tr>										<input type="hidden" id="1" value=<s:property value="list[1]"/> >
								...
								<form method="post" action="ssendallchat">
									<div class="chat-form">

										<div class="input-cont">   
											<input class="m-wrap" type="text" placeholder="Type a message here..." name="currentChat.message"/>
