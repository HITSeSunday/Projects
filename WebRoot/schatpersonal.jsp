			...
			<div class="container-fluid">
				...
				<ul class="nav pull-right">
					...
					<li class="dropdown user"><a href="#" class="dropdown-toggle"
						data-toggle="dropdown"> <span class="username"><%=session.getAttribute("studentname")%></span>
						...
						<ul class="dropdown-menu">
							...
							<li><a href="page_calendar.html"><i
									class="icon-calendar"></i> 我的预约</a></li>
	...
	<div class="page-container row-fluid">
		...
		<div class="page-sidebar nav-collapse collapse">
			...
			<ul class="page-sidebar-menu">
				...
				<li class="start "><a
					href="<%=basePath%>chat/sviewunreadchat.action"> <i
						class="icon-home"></i> <span class="title">本站简介</span>

				</a></li>

				<li class=""><a href="javascript:;"> <i
						class="icon-bookmark-empty"></i> <span class="title">教师预约</span> <span
						class="arrow "></span>
...
<td>
				...
				<li class=""><a href="<%=basePath%>s_calendar.jsp"> <i
								...
								<div class="chat-form">
									...
									<div class="input-cont">
										<input class="m-wrap" type="text"
											...
											name="currentChat.sid"
											value="<%=session.getAttribute("studentid")%>" /> <input
											type="hidden" name="currentChat.writer"
											value="<%=session.getAttribute("studentname")%>" /> <input
											type="hidden" name="currentChat.tid"
											value="<%=request.getAttribute("currentChat.tid")%>" />
