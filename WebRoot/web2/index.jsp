				...
				<ul class="nav pull-right">
					...
					<li class="dropdown user">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="login_soft.html"><i class="icon-key"></i> 退出登录</a></li>
				...
				<li class="">
					...
					<ul class="sub-menu">
						...
						<li >
							...
							<a href="<%=basePath %>jdbc/TeacherShow?techerid=1">
		...
		<div class="page-content">
			...
			<div class="container-fluid">
				...
				<div id="dashboard">
					...
					<iframe src="ReserveSlide1.html" id="frame1" frameborder="0" width="1100" height="900"></iframe>
